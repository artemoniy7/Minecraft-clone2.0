...
void renderInventory(int screenW, int screenH) {
    ...
    glm::mat4 blockPreviewModel = glm::mat4(1.0f);
    blockPreviewModel = glm::rotate(blockPreviewModel, glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
    blockPreviewModel = glm::rotate(blockPreviewModel, glm::radians(225.0f), glm::vec3(0.0f, 1.0f, 0.0f));
    blockPreviewModel = glm::scale(blockPreviewModel, glm::vec3(0.87f));
